...
import RefreshableComponent from "../../Components/RefreshableComponent/RefreshableComponent"; // Import the component
import "./Auth.css";
  ...
  return (
    <div className="Auth_container" onClick={() => setAuthBtn(false)}>
      <div className="Auth_container2">
        ...
        <div> Points {User.result.points}</div>
        ...
        <RefreshableComponent User={User} />
      </div>
    </div>
  );
}
